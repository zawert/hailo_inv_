...
router.route('/inventory/pdf/:id').get(catchErrors(inventoryController.generatePDF));
router.route('/inventory/summary').get(catchErrors(inventoryController.summary));
router.route('/inventory/mail').post(catchErrors(inventoryController.sendMail));
